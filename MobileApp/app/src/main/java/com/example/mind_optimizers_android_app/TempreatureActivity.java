...
public class TempreatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tempreature);
    ...
    private void simulateAmbientTemperature() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            @Override
            public void run() {
                temperature = Utils.randInt(97, 100);
...
public class TempreatureActivity extends AppCompatActivity implements SensorEventListener {
